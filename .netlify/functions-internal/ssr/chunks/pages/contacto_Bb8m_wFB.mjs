...
const $$Layout = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<html lang="en" data-astro-cid-dmqsi53g> <head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>Conversa | ${title}</title><link rel="icon" type="image/x-icon" href="./img/favicon-conver.png"><!-- <link rel="icon" type="image/x-icon" href="./img/favicon-conversa.svg"> -->${renderHead()}</head> <body data-astro-cid-dmqsi53g> <main data-astro-cid-dmqsi53g> <nav class="menu" data-astro-cid-dmqsi53g> <div class="opciones" data-astro-cid-dmqsi53g> <span class="logo" onclick="window.location.href = './';" data-astro-cid-dmqsi53g>
Conversa
